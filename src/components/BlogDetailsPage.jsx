  ...
  return (
    <div className="md:px-20 px-6 pt-28 sm:pt-32 bg-white">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-3 text-black leading-snug">{blog.title}</h1>
        ...
        <div className={blogContentClass} dangerouslySetInnerHTML={{ __html: blog.desc }} />
      </div>

      ...
      <div className="mx-auto flex flex-col md:flex-row-reverse items-center justify-between gap-10 md:gap-4">
        ...
        >
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="absolute md:top-20 top-16 z-20 text-white px-7 w-full space-y-3"
          >
            ...
            <p className="md:text-[16px] text-sm opacity-90 leading-relaxed">
              Discover popular stories in top categories such as tech, business, finance, and health news. Stay updated stay inspired.
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          ...
          >
            Stay informed with expert-written articles across technology, business, finance, and health.
          ...
          >
            Our blogging platform publishes daily updates in multiple categories so readers can explore tech innovations, business strategies, healthcare advice, and finance highlights.
          </motion.p>
        </motion.div>
      </div>
    </section>

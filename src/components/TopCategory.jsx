...
export default function TopCategory() {
  ...
  return (
    <div className="w-full flex flex-col px-6 md:px-20 gap-6 py-8 bg-white overflow-hidden">
      {/* Title outside the flex row for full width */}
      <motion.div
      ...
      <div className="flex flex-col md:flex-row gap-6">
            ...
            >
              ...
              >
                {featured.map((blog, idx) => (
                  <div
                    key={idx}
                    className="relative w-full flex-shrink-0 h-[250px] md:h-[470px] snap-start rounded-xl overflow-hidden shadow-md"
                  >
                    <Link href={`/blogs/${blog.category.toLowerCase()}/${blog.slug}`}>
                      <div className="relative w-full h-full">
                        ...
                        />
                        <div className="absolute md:mt-40 mt-5 inset-0 bg-gradient-to-t from-black via-black/90 to-transparent md:px-12 px-7 pb-6 z-10 flex flex-col justify-center">
                          <div className="mb-4">
        ...
        {/* Right: Famous Blogs */}
        <div className="w-full md:w-1/3 space-y-6 mt-4 md:mt-0">
          {(loading ? Array(2).fill({}) : famous).map((b, idx) => (
            <motion.div
              ...
              viewport={{ once: true }}
              onAnimationComplete={() => (hasAnimated.current = true)}
              className="relative md:h-[222px] h-[170px] rounded-xl overflow-hidden shadow-md"
            >
              {loading ? (

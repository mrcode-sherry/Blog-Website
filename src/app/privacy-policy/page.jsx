      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <section className="w-full lg:w-[75%] space-y-6">
          ...
          <motion.h3
            ...
            animate="visible"
            custom={0.3}
            className="text-lg font-semibold text-indigo-600 mt-6"
          >
          ...
          <motion.ul
            ...
            animate="visible"
            custom={0.35}
            className="list-disc pl-6 text-gray-700 text-base space-y-1"
          >
          ...
          >
            To exercise your rights, email us at <a href="mailto:privacy@kintechy.com" className="text-indigo-600 underline">privacy@kintechy.com</a>. We respond within 7 days.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-base text-gray-700 leading-relaxed"
          >
            We do not knowingly collect data from children. If you're a parent and believe your child has shared personal info, contact us immediately at <a href="mailto:privacy@kintechy.com" className="text-indigo-600 underline">privacy@kintechy.com</a>.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-base text-gray-700 leading-relaxed"
          >
            For any questions regarding this Privacy Policy, cookies, or data usage, contact us at <a href="mailto:privacy@kintechy.com" className="text-indigo-600 underline">privacy@kintechy.com</a> or write to:
            <br />
